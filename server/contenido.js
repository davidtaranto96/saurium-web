...
const generadores = {
  ...
  'correo': (c) => `<a href="mailto:${esc(c.correo)}" data-i18n="contact.mail" class="cta-linea cta-linea-claro" style="display:inline-flex;align-items:center;padding:16px 28px;border-radius:999px;font-weight:600;font-size:15px;border:1.5px solid rgba(243,235,222,0.45);color:var(--crema)">${esc(c.correo)}</a>`,
